    ...
    <section className="bg-[#00000018]    ">
      <div className=" container-wrapper pt-[25%] sm:pt-[1%]  overflow-hidden relative">
        <div>
          ...
          /> */}
          <h1 className=" font-dream text-xl sm:text-8xl font-bold text-center stroke-slate-950 txts  " id="logo">$BluePepe</h1>
          {/* <a href="/" className="text-sm sm:text-2xl font-bold text-center flex justify-center my-4"> </a> */}
        </div>
        <img
          src="images/hero4.png"
          alt=""
          className=" mx-auto h-auto sm:h-[350px] zoom-in-out-box"
          data-aos="zoom-in-up"
          data-aos-duration="1500"
        />
        ...
        <div className=" relative  "  data-aos="zoom-in-right"
          ...
          <div className=" flex flex-row  justify-center items-center gap-4 w-full max-w-[200px] sm:max-w-[250px] mx-auto py-4">
            ...
            <a
              href="https://www.dextools.io/app/en/solana/pair-explorer/AW9iP3tiznZJv2u537ZqhBQ5yf6MYjGmBzJkix6ZAr9i?t=1722344018767"
        ...
        <div  data-aos="zoom-in-up"
          data-aos-duration="1500" className=" flex mt-4 mb-2 items-center justify-center gap-2  relative z-20 py-1 bg-black border-t-2 border-l-2 border-r-2 border-[#045ef0] rounded-2xl w-full max-w-full sm:max-w-xl px-4 mx-auto">
          <CopyAddress />{" "}
